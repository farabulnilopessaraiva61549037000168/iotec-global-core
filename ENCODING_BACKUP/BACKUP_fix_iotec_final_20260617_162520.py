...
# ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â¥ INJEÃƒÆ'Ã¢â‚¬Â¡ÃƒÆ'Ã†â€™O DE CONFIG SEGURA NO __init__
patch = """
...
# injeta depois do __init__ (heurÃƒÆ'Ã‚Â­stica simples)
text = text.replace(
    "def __init__(self",
    "def __init__(self" + patch
)

# fallback adicional direto no acesso problemÃƒÆ'Ã‚Â¡tico
text = re.sub(
