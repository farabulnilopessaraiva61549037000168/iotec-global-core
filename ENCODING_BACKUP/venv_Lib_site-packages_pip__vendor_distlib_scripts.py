...
class ScriptMaker(object):
    ...
    def _get_shebang(self, encoding, post_interp=b'', options=None):
        ...
        # they aren't always. For example, a path containing a ÃƒÆ'Ã‚Â¡Ãƒâ€šÃ‚ÂºÃƒâ€¦Ã‚Â¾ (which is a
        # LATIN CAPITAL LETTER SHARP S - U+1E9E) is normcased to ÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â¸ (which is a
