...
# MAPA VIVO DE EXECUÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O REAL DO NÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â¡CLEO
# =========================================================
...
# =========================================================
# EXTRAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O AST
# =========================================================
...
print("\n[EXECUTION BRAIN] Escaneando nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo...\n")
...
# =========================================================
# DETECTAR CÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°REBRO CENTRAL
# =========================================================
...
print("ÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸  CÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°REBRO OPERACIONAL:\n")

for node, score in brain_score[:15]:
    print(f"{node} -> {score} conexÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes")

print("\nÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â¥ MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œDULOS MAIS EXECUTÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂVEIS:\n")

for node, score in top_runtime:
    print(f"{node} -> score {score}")

print("\nÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¡Ãƒâ€šÃ‚Âª ENTRYPOINTS:\n")

for e in entrypoints[:20]:
    print(e)

print("\nÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â  POSSÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂVEIS MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œDULOS MORTOS:\n")

for d in dead_modules[:20]:
    print(d)

print("\n=======================================")
print("ANÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂLISE FINALIZADA")
print("=======================================\n")

print("RelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio salvo:")
