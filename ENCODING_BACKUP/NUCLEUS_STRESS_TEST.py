...
for sistema in TESTES:
    ...
    print()
    print(
        f"USUÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂRIOS -> {usuarios}"
    )
    ...
    print(
        f"PRESSÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O -> {pressao}"
    )

    print(
        f"RESISTÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIA -> {resistencia}%"
    )

    print(
        f"LATÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIA -> {latencia}ms"
    )
...
print()
print(
    f"USUÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂRIOS SIMULADOS -> {TOTAL_USUARIOS}"
)

print()
print(
    f"RESISTÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIA MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°DIA -> {MEDIA_RESISTENCIA}%"
)

print()
print(
    f"LATÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIA MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°DIA -> {MEDIA_LATENCIA}ms"
)
...
print()
print("===================================================")
print(" INSPEÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O FINALIZADA")
print("===================================================")
