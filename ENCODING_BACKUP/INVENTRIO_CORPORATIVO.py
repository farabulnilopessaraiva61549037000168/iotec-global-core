...
try:
    ...
    pass
# =========================================================
# IOTEC INVENTÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂRIO CORPORATIVO IMPERIAL
...
# =========================================================
# VALORAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O
# =========================================================
...
def gerar_relatorio_txt(dados):
    ...
    with open(
        ...
        f.write("=" * 70 + "\n")
        f.write(" IOTEC INVENTÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂRIO CORPORATIVO IMPERIAL\n")
        f.write("=" * 70 + "\n\n")

        f.write(f"TOTAL DE ATIVOS: {total}\n")
        f.write(f"ATIVOS ESTRATÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°GICOS: {estrategicos}\n")
        ...
        f.write("\n")
        f.write("=" * 70 + "\n")
        f.write(" FIM DO RELATÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œRIO\n")
        f.write("=" * 70 + "\n")
...
def executar_inventario():
    ...
    print("=" * 70)
    print(" IOTEC INVENTÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂRIO CORPORATIVO IMPERIAL")
    print("=" * 70)
    print()
    ...
    print()
    print("=" * 70)
    print(" INVENTÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂRIO FINALIZADO")
    print("=" * 70)
