...
# com leitura automÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡tica de links de pagamento (PicPay e outros)
# dentro do nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo central, geraÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o de QR Codes vÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lidos e
# exposiÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o visual premium dos produtos.
#
# RECURSOS:
# - Portal institucional novo
# - Leitura automÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡tica de links em .txt, .json, .md, .csv, .py
# - DetecÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o de links PicPay
# - AssociaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o de links aos produtos
# - GeraÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o de QR Code real com base no link encontrado
# - CatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡logo JSON persistente
# - Logs
# - Fallback seguro
#
...
#   http://127.0.0.1:8080
#
# OBSERVAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O:
# - Ajuste NUCLEO_DIR se quiser apontar para outro diretÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio.
# - O QR Code sÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³ serÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡ gerado se houver link real encontrado.
# ============================================================
...
# ------------------------------------------------------------
# AUTO-INSTALAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O DE DEPENDÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIAS
# ------------------------------------------------------------
def garantir_dependencia(pacote: str, import_name: Optional[str] = None) -> None:
    ...
    try:
        ...
        print(f"[INFO] Instalando dependÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia: {pacote}")
...
# ------------------------------------------------------------
# CONFIGURAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O GERAL
# ------------------------------------------------------------
...
# AJUSTE AQUI SE QUISER APONTAR DIRETAMENTE PARA O NÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â¡CLEO
...
def slugify(texto: str) -> str:
    ...
    mapa = {
        "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡": "a", "ÃƒÆ'Ã†â€™ ": "a", "ÃƒÆ'Ã†â€™": "a", "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¢": "a",
        "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©": "e", "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âª": "e",
        "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­": "i",
        "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³": "o", "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµ": "o", "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â´": "o",
        "ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âº": "u",
        "ÃƒÆ'Ã†â€™": "c"
    }
...
def copiar_para_area_trabalho(arquivo: Path) -> Optional[Path]:
    try:
        ...
        logging.warning(f"Falha ao copiar arquivo para ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡rea de trabalho: {e}")
    return None
    ...
    produtos = [
        {
            ...
            "categoria": "AvaliaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o Empresarial",
            "descricao": "AvaliaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o estratÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©gica com score institucional, leitura de maturidade analÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­tica e parecer executivo para posicionamento competitivo.",
            "preco": 997.00,
            "publico_alvo": "Empresas, consultorias, instituiÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes e gestores",
            "entrega": "RelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio + score + parecer executivo",
            "ativo": True,
            "destaque": True,
        ...
        {
            "id": "P002",
            "nome": "GestÃƒÆ'Ã†â€™o de Crises com InteligÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia Artificial",
            "slug": "gestao-de-crises-com-inteligencia-artificial",
            "categoria": "GestÃƒÆ'Ã†â€™o de Crises",
            "descricao": "AnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lise situacional, classificaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o de risco, apoio ÃƒÆ'Ã†â€™  decisÃƒÆ'Ã†â€™o e inteligÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia aplicada para cenÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡rios crÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­ticos.",
            "preco": 2497.00,
            "publico_alvo": "ÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œrgÃƒÆ'Ã†â€™os, prefeituras, defesa civil, consultorias e operaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes sensÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­veis",
            "entrega": "DiagnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³stico + painel + orientaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o tÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©cnica",
            "ativo": True,
            "destaque": True,
        ...
        {
            "id": "P003",
            "nome": "SeguranÃƒÆ'Ã†â€™a ViÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡ria Inteligente",
            "slug": "seguranca-viaria-inteligente",
            "categoria": "SeguranÃƒÆ'Ã†â€™a ViÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡ria",
            "descricao": "AnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lise de mobilidade, risco e criticidade operacional para apoio tÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©cnico em polÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­ticas de seguranÃƒÆ'Ã†â€™a viÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡ria.",
            "preco": 1897.00,
            "publico_alvo": "MunicÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­pios, secretarias, gestores de trÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¢nsito e empresas",
            "entrega": "RelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio + indicadores + plano de aÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o",
            "ativo": True,
            "destaque": False,
        ...
        {
            "id": "P004",
            "nome": "AssistÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia AnalÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­tica Institucional",
            "slug": "assistencia-analitica-institucional",
            "categoria": "Assessoria",
            "descricao": "ServiÃƒÆ'Ã†â€™o digital de apoio analÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­tico para tomada de decisÃƒÆ'Ã†â€™o, leitura de cenÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡rios e inteligÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia aplicada.",
            "preco": 3500.00,
            "publico_alvo": "Empresas, ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rgÃƒÆ'Ã†â€™os, lideranÃƒÆ'Ã†â€™as e operaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes institucionais",
            "entrega": "AssistÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia tÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©cnica + relatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rios + suporte analÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­tico",
            "ativo": True,
            "destaque": False,
        ...
        },
        {
            ...
            "descricao": "Pacote executivo com avaliaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o institucional, posicionamento global e estrutura premium de apresentaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o.",
            "preco": 8900.00,
            "publico_alvo": "Diretores, investidores, empresas e projetos em expansÃƒÆ'Ã†â€™o",
            "entrega": "DossiÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âª premium + parecer + plano executivo",
            "ativo": True,
            "destaque": True,
...
def inicializar_catalogo() -> Dict:
    if not CATALOGO_FILE.exists():
        ...
        logging.info("CatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡logo base criado.")
        return dados
...
def criar_mapeamento_base() -> Dict[str, List[str]]:
    """
    VocÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âª pode editar este arquivo depois para amarrar explicitamente
    nomes/termos dos arquivos do nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo a cada produto.
    """
    mapeamento = {
...
# ------------------------------------------------------------
# VARREDURA DE LINKS DE PAGAMENTO NO NÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â¡CLEO
# ------------------------------------------------------------
...
def varrer_pagamentos_no_nucleo(nucleo_dir: Path) -> List[Dict]:
    ...
    if not nucleo_dir.exists():
        logging.warning(f"NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo nÃƒÆ'Ã†â€™o encontrado: {nucleo_dir}")
        return resultados
    ...
    logging.info(f"Varredura de pagamentos concluÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­da. Links encontrados: {len(resultados)}")
    return resultados

# ------------------------------------------------------------
# ASSOCIAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O LINK -> PRODUTO
# ------------------------------------------------------------
...
def gerar_relatorio_execucao(catalogo: Dict, pagamentos: List[Dict]) -> Path:
    linhas = []
    linhas.append("=" * 70)
    linhas.append("RELATÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œRIO EXECUTIVO - PORTAL E PAGAMENTOS")
    linhas.append("=" * 70)
    linhas.append(f"Empresa          : {APP_NAME}")
    linhas.append(f"MÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³dulo           : {MODULE_NAME}")
    linhas.append(f"Gerado em        : {agora().strftime('%d/%m/%Y %H:%M:%S')}")
    linhas.append(f"NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo analisado : {resumo_caminho(NUCLEO_DIR)}")
    ...
    for produto in produtos:
        ...
        linhas.append(f"PreÃƒÆ'Ã†â€™o            : {produto.get('preco_formatado', '')}")
        linhas.append(f"Pagamento        : {produto.get('tipo_pagamento', 'NÃƒÆ'Ã†â€™o associado') or 'NÃƒÆ'Ã†â€™o associado'}")
        linhas.append(f"Link             : {produto.get('link_pagamento', '') or 'NÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O ENCONTRADO'}")
        linhas.append(f"Origem           : {produto.get('origem_pagamento', '') or 'NÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O LOCALIZADA'}")
        linhas.append("-" * 70)

    linhas.append("")
    linhas.append(f"Produtos ativos           : {ativos}")
    linhas.append(f"Produtos com pagamento    : {com_pagamento}")
    linhas.append(f"Valor nominal do catÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡logo : {formatar_brl(soma)}")
    linhas.append(f"SimulaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o 1 venda/produto : {formatar_brl(soma)}")
    linhas.append(f"SimulaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o mensal (22 dias): {formatar_brl(soma * 22)}")
    linhas.append(f"SimulaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o anual           : {formatar_brl(soma * 22 * 12)}")
...
Se nÃƒÆ'Ã†â€™o houver mÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­dia, o portal usa fundo premium padrÃƒÆ'Ã†â€™o.
"""
...
<head>
    <meta charset="UTF-8">
    <title>IOTEC BL ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Construtora de Tecnologia</title>
    ...
    <div class="topbar-inner">
        <div class="brand">
            ...
            <div class="brand-text">
                <h1>IOTEC BL ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Construtora de Tecnologia</h1>
                <p>Arquitetura digital, inteligÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia aplicada e soluÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes tecnolÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³gicas para mercado, gestÃƒÆ'Ã†â€™o e expansÃƒÆ'Ã†â€™o institucional</p>
            </div>
        </div>
        <nav class="menu">
            <a href="#solucoes">SoluÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes</a>
...
<section class="hero">
    <div class="hero-main">
        ...
        <div class="hero-content">
            <div class="kicker">CONSTRUTORA DE TECNOLOGIA ÃƒÆ'Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· PORTAL EXECUTIVO</div>
            <h2>PresenÃƒÆ'Ã†â€™a institucional, soluÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes digitais e arquitetura comercial em um ambiente visual premium.</h2>
            <p>
                A IOTEC BL estrutura soluÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes tecnolÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³gicas com foco em inteligÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia aplicada, organizaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o operacional,
                apresentaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o institucional e capacidade de expansÃƒÆ'Ã†â€™o para mercados pÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºblicos e privados.
            </p>
            <div class="hero-actions">
                <a href="#solucoes" class="btn btn-primary">Explorar soluÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes</a>
            ...
            <div class="hero-stats">
                ...
                <div class="hero-stat">
                    <div class="label">Valor do catÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡logo</div>
    ...
    <aside class="hero-side">
        <div class="side-media-stack">
            ...
            <div class="media-card">
                ...
                {% else %}
                    <img src="/images/{{ item.arquivo }}" alt="MÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­dia institucional">
                {% endif %}
        ...
        <div class="side-panel">
            ...
            <p>
                Este ambiente lÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âª a base interna, localiza links de pagamento, associa QR Codes vÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lidos e organiza
                a apresentaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o institucional em uma vitrine digital mais robusta e coerente com a marca.
            </p>
            <div class="pill-list">
                <div class="pill">Leitura automÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡tica de pagamentos do nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo</div>
...
<section class="section" id="solucoes">
    <div class="section-head">
        <div>
            <h3>CatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡logo executivo de soluÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes</h3>
            <p>Produtos e serviÃƒÆ'Ã†â€™os organizados para exposiÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o comercial, apresentaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o institucional e operaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o digital.</p>
        </div>
    </div>
        ...
        <article class="product-card" id="pagamentos">
            ...
            <div class="product-body">
                <div>
                    ...
                    <div class="meta-box">
                        <div class="meta-label">PÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºblico-alvo</div>
                    ...
                    <div class="meta-box">
                        ...
                        <div class="meta-value">
                            {{ p.origem_pagamento if p.origem_pagamento else 'Nenhum link vÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lido associado atÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â© o momento.' }}
                        </div>
                    </div>
                </div>
                ...
                <div class="qr-panel">
                    ...
                    {% else %}
                        <div class="qr-fallback">
                            Pagamento nÃƒÆ'Ã†â€™o associado.<br>
                            O QR Code sÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³ ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â© exibido quando um link vÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lido ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â© encontrado no nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo.
                        </div>
                    {% endif %}
                </div>
            </div>
            ...
            <div class="product-footer">
                <div class="price-row">
                    <div>
                        <div class="price-label">PreÃƒÆ'Ã†â€™o</div>
                ...
                <div class="footer-actions">
                    ...
                    {% else %}
                        <button class="btn btn-secondary" disabled>Pagamento indisponÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­vel</button>
...
<footer class="footer">
    <div class="footer-inner">
        <div>IOTEC BL ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ Construtora de Tecnologia</div>
        <div>{{ gerado_em }}</div>
...
async function ativarFullscreen(){
    try{
        ...
        console.log("Fullscreen indisponÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­vel.", e);
    }
}
async function copiarTexto(texto){
    ...
    try{
        ...
        alert("NÃƒÆ'Ã†â€™o foi possÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­vel copiar o link.");
    }
}
</script>
</body>
...
def home():
    ...
    if len(laterais) > 0:
        ...
        side_cards.append({"tipo": "video", "arquivo": lateral_video, "rotulo": "VÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­deo institucional"})

    if len(laterais) > 1:
        side_cards.append({"tipo": "imagem", "arquivo": laterais[1], "rotulo": "PresenÃƒÆ'Ã†â€™a corporativa"})
    elif lateral_video:
        side_cards.append({"tipo": "video", "arquivo": lateral_video, "rotulo": "Estrutura visual"})

    if lateral_video:
        side_cards.append({"tipo": "video", "arquivo": lateral_video, "rotulo": "MÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­dia institucional"})
    elif len(laterais) > 2:
...
def preparar_portal() -> Dict:
    ...
    logging.info(f"RelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio gerado em {relatorio}")
...
def main():
    ...
    print(f"NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo analisado     : {NUCLEO_DIR}")
    print(f"CatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡logo             : {CATALOGO_FILE}")
    print(f"Pagamentos encontrados: {len(resultado['pagamentos'])}")
    print(f"RelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio            : {resultado['relatorio']}")
    print(f"Backup               : {resultado['backup']}")
    print("-" * 76)
    print(f"ACESSO LOCAL         : http://127.0.0.1:{PORT}")
    print(f"ACESSO NA REDE       : http://{ip_local}:{PORT}")
    print("-" * 76)
    print("ObservaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o: o QR Code sÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³ ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â© gerado quando um link real ÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â© localizado no nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo.")
    print("=" * 76)
