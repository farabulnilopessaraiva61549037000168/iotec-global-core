...
try:
    ...
    pass
# ==============================
# IOTEC SENTINEL - NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂVEL MÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂXIMO REGIONAL (VERSÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O PROFISSIONAL)
# ==============================
...
REGIAO = {
    "Vale do Jaguaribe": {
        "SÃƒÆ'Ã†â€™o JoÃƒÆ'Ã†â€™o do Jaguaribe": {
            "Centro": (-5.146, -38.100),
...
class PainelPrincipal(QMainWindow):
    ...
    def init_ui(self):
        ...
        btn_simular = QPushButton("INICIAR OCORRÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIA")
        ...
        self.risco = self.criar_modulo("ANÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂLISE DE RISCO REGIONAL")
    ...
    def calcular_risco(self):
        ...
        for cidade, qtd in contagem.items():
            if qtd >= 8:
                ...
                nivel = "MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°DIO"
            else:
                nivel = "BAIXO"
    ...
    def gerar_mensagem_ia(self, top):
        frases = [
            f"A cidade de {top[0]} apresenta {top[2]} ocorrÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncias recentes. AtenÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o reforÃƒÆ'Ã†â€™ada recomendada.",
            f"Detectado aumento de ocorrÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncias em {top[0]}. Avaliar reforÃƒÆ'Ã†â€™o operacional imediato.",
            f"PadrÃƒÆ'Ã†â€™o de incidÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia identificado em {top[0]} com {top[2]} registros recentes.",
        ]
    ...
    def atualizar_dados(self):
        ...
        for cidade, nivel, qtd in riscos:
            simbolo = "ÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â´" if nivel == "ALTO" else "ÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¡" if nivel == "MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°DIO" else "ÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¢"
            self.risco.texto.append(f"{simbolo} {cidade}: {nivel} ({qtd} ocorrÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncias)")
    ...
    def iniciar_ocorrencia(self):
        self.alertas.texto.append("=== OPERAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O INICIADA ===")
