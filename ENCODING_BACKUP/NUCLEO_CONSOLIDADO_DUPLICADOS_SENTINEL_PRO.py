...
TIPOS = ["OcorrÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia registrada", "Atividade suspeita", "Monitoramento ativo"]
...
class Sistema(QMainWindow):
    ...
    def init_ui(self):
        ...
        # MENU
        menu = QVBoxLayout()
        menu.addWidget(QLabel("RegiÃƒÆ'Ã†â€™o de monitoramento"))
        ...
        conteudo.addWidget(QLabel("SituaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o operacional"))
        self.status = QTextEdit()
        self.status.setReadOnly(True)
        conteudo.addWidget(self.status)

        conteudo.addWidget(QLabel("AnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lise automÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡tica"))
    ...
    def criar_mapa(self):
        ...
        # CAMADA TÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂTICA (visual forte)
    ...
    def analisar(self):
        ...
        return (
            f"RegiÃƒÆ'Ã†â€™o crÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­tica identificada: {cidade}.\n"
            f"Volume elevado de registros recentes.\n"
            f"AÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o recomendada: monitoramento intensivo."
        )
