...
# EMPRESA: IOTEC
# MODO: INTERMEDIAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O INTELIGENTE DE ATIVOS
...
EMPRESA = {
    ...
    "pais_base": "Brasil",
    "modo_operacional": "INTERMEDIAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O INTELIGENTE",
    "status": "ONLINE",
...
# ============================================================
# MOTOR DE COMISSÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O
# ============================================================
...
# ============================================================
# SIMULAR NEGÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œCIO
# ============================================================
...
def fechar_negocio(ativo_id, cliente_nome):
    ...
    for ativo in ATIVOS:
        ...
        if ativo["id"] == ativo_id:
            ...
            print("\n================================================")
            print(" NEGÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œCIO FECHADO")
            print("================================================")

            print(f"\nATIVO: {ativo['titulo']}")
            print(f"CLIENTE: {cliente_nome}")
            print(f"COMISSÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O: US$ {comissao:,.2f}")
...
def torre_executiva():
    ...
    print(
        f"NEGÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œCIOS FECHADOS: "
        f"{TORRE_CONTROLE['negocios_fechados']}"
    )

    print(
        f"COMISSÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O PREVISTA: "
...
def exportar_relatorio():
    ...
    print("\n================================================")
    print(" RELATÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œRIO EXPORTADO")
    print("================================================")
