...
# =========================================================
# IOTEC AI v6
# MOTOR SEMÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡NTICO COM SCORE DE RELEVÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡NCIA
# =========================================================
# OBJETIVO:
# Corrigir falsos positivos semÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¢nticos
# usando pontuaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o contextual inteligente.
# =========================================================
...
RECOMENDACOES = {
    ...
    "industrial": [
        ...
        "AutomaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o produtiva"
    ],
...
class MotorSemantico:
    ...
    # =====================================================
    # MOTOR SEMÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡NTICO COM SCORE
    # =====================================================
    ...
    def detectar_categorias(self, texto):
        ...
        # -------------------------------------------------
        # COMPARAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O INTELIGENTE
        # -------------------------------------------------
    ...
    def investigar(self):
        ...
        print("\n====================================================")
        print("        IOTEC AI - MOTOR SEMÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡NTICO v6")
        print("====================================================")
        ...
        self.pensar("Calculando relevÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¢ncia contextual...")
        ...
        if categorias:
            ...
            for categoria, score in categorias:
                ...
                print(f"Score semÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¢ntico: {score}")
    ...
    def relatorio_final(self):
        ...
        self.pensar("Gerando diagnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³stico operacional...")
        self.pensar("Calculando arquitetura inteligente...")
        self.pensar("Encaminhando ao nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo produtivo...")
