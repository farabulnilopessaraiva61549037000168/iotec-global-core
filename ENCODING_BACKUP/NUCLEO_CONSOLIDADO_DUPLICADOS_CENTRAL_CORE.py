...
try:
    ...
    pass
# ============================================================
# IOTEC - CENTRAL OPERACIONAL DO NÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â¡CLEO
...
# ============================================================
# SETORES ECONÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂMICOS
# ============================================================
...
# ============================================================
# CLIMA ECONÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂMICO
# ============================================================
...
# ============================================================
# CENTRAL DE PRODUÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O
# ============================================================
...
def exibir_relatorio():
    ...
    print("\n===================================================")
    print(" CLIMA ECONÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂMICO")
    print("===================================================\n")
    ...
    for setor, dados in painel["metas"].items():
        ...
        print(f"META MÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â S: R$ {dados['meta_mes']}")
        print(f"TICKET BRL: R$ {dados['ticket_brl']}")
        print(f"TICKET USD: $ {dados['ticket_usd']}")
        print(f"TICKET EUR: ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ {dados['ticket_eur']}")
        print("---------------------------------------------------")
    ...
    print(f"PAÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂS: {lead['pais']}")
    ...
    print(f"EUROPA: ÃƒÆ'Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ {fat['europa_eur']}")
    ...
    print("\n===================================================")
    print(" NÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â¡CLEO OPERACIONAL FINALIZADO")
    print("===================================================\n")
