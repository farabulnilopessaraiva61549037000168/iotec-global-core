...
# =========================
# SAFE PROJECT FILTER LAYER
# =========================

EXTERNAL_MODULES = set([
    "sys  # filtered-protected","os","json","time","re","math",
...
# -----------------------------
# 2. EXTRAÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O DE DEPENDÃƒÆ'Ã†â€™Ãƒâ€¦Ã‚Â NCIAS
# -----------------------------
...
# -----------------------------
# 3. CONSTRUÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O DO GRAFO
# -----------------------------
def build_graph():
    name_map = {}
...
# -----------------------------
# 4. CENTRALIDADE (cÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©rebro real)
# -----------------------------
def compute_centrality():
    ...
    for node in reverse_graph:
        scores[node] += len(reverse_graph[node]) * 3  # dependÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia recebida

    return scores

# -----------------------------
# 5. DETECTA MÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œDULO CÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°REBRO
# -----------------------------
...
# -----------------------------
# 8. EXECUÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢O
# -----------------------------
def run():
    print("\n[NEURAL MAP] Escaneando nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo...")
    ...
    print("NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³s no grafo:", len(graph))

    print("\nÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸  CÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°REBRO REAL DO SISTEMA:")
    print(brain)

    print("\nÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒâ€šÃ‚Â¥ HOT NODES:")
    for h in hot:
        print(h[0], "->", len(h[1]), "conexÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes")

    print("\nÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â  ISOLADOS:")
    print(len(isolated), "mÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³dulos")

    print("\nRelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio salvo: IOTEC_NEURAL_MAP_REPORT.json")
