...
function abrirServico(tipo) {
    ...
    if (tipo === "auditoria") {
        conteudo = "<h1>Auditoria TÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©cnica</h1><p>AnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lise completa da sua operaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o.</p>";
    }
    ...
    if (tipo === "seguranca") {
        conteudo = "<h1>CiberseguranÃƒÆ'Ã†â€™a</h1><p>ProteÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o de dados.</p>";
    }
