...
def run():
    print("\n[NEURAL FIX] Iniciando anÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lise segura...\n")
    ...
    print("ÃƒÆ'Ã‚Â°Ãƒâ€¦Ã‚Â¸  TOP NÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œS REAIS DO SEU SISTEMA:\n")
    for f, s in core:
        print(f"{os.path.basename(f)} -> {s} conexÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âµes")

    print("\nÃƒÆ'Ã‚Â¢Ãƒâ€¦Ã‚Â¡  RUÃƒÆ'Ã†â€™Ãƒâ€šÃ‚ÂDO (IGNORADO NO CÃƒÆ'Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°REBRO):\n")
    ...
    print("\nRelatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio salvo: IOTEC_NEURAL_MAP_CLEAN.json")
