...
node_code = '''const { default: makeWASocket, useMultiFileAuthState, DisconnectReason } = require('@whiskeysockets/baileys');
...
print("[OK] Arquivo node_jonas_core.js regravado com sucesso.")
