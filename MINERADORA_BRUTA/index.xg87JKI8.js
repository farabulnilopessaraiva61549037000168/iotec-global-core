import{x as c,a4 as l,r as i,j as e,a$ as p}from"./index.3bHSf9gi.js";import{P as d,R as f}from"./Particles.Cg5ey-rW.js";const g=""+new URL("../media/C:/IOTEC/MINERADORA_BRUTA/flake-0.DgWaVvm5.png",import.meta.url).href,u=""+new URL("../media/C:/IOTEC/MINERADORA_BRUTA/flake-1.B2r5AHMK.png",import.meta.url).href,x=""+new URL("../media/C:/IOTEC/MINERADORA_BRUTA/flake-2.BnWSExPC.png",import.meta.url).href,o=150,s=150,E=10,S=90,_=4e3,a=(t,n=0)=>Math.random()*(t-n)+n,w=()=>l(`from{transform:translateY(0)
      rotateX(`,a(360),`deg)
      rotateY(`,a(360),`deg)
