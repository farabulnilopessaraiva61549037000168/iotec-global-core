    ...
    def validate(self, envelope: CommandEnvelope) -> Dict[str, Any]:
        ...
        if self.config.get("reliability", {}).get("block_on_untrusted_formula", True):
            ...
            if envelope.metadata.get("formula_trusted", True) is False:
                ...
                reasons.append("FÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rmula rejeitada por falta de respaldo.")
...
class GravityController:
    ...
    def pull_to_core(self, plate: str, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        append_log(self.log_path, "RETURN", f"Placa '{plate}' retornou ao nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo.")
...
class PlateExecutor:
    ...
    def _analyze(self, envelope: CommandEnvelope, compressed: float) -> Dict[str, Any]:
        ...
        payload = {
            ...
            "insight": envelope.metadata.get("insight", "AnÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â¡lise concluÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­da com critÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â©rio."),
...
class Nucleus:
    ...
    def decide(self, envelope: CommandEnvelope) -> Dict[str, Any]:
        ...
        append_log(self.log_path, "DECIDE", f"NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo avaliando objetivo='{envelope.objective}' na placa='{envelope.plate}'")
...
def bootstrap_demo_cycles(nucleus: Nucleus, cycles: int = 1) -> List[Dict[str, Any]]:
    ...
    demo_envelopes: List[CommandEnvelope] = [
        ...
        CommandEnvelope(
            ...
            objective="Coletar sinais e ativos comerciais do reservatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio local",
            ...
            metadata={
                ...
                "sources": ["Desktop", "Downloads", "ReservatÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³rio IOTEC"],
        ...
        CommandEnvelope(
            ...
            objective="Sanear duplicados e isolar resÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â­duos sistÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªmicos",
        ...
        CommandEnvelope(
            ...
            objective="Analisar valor comercial e aderÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªncia do portfÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³lio",
            ...
            metadata={
                ...
                "insight": "PortfÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Â³lio apto para apresentaÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o seletiva e integraÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o futura.",
        ...
        CommandEnvelope(
            ...
            objective="Monitorar estabilidade do planeta sistÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âªmico",
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="NÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo Gravitacional IOTEC")

    parser.add_argument("--cycles", type=int, default=1, help="Quantidade de ciclos demonstrativos.")

    parser.add_argument("--describe", action="store_true", help="Exibe descriÃƒÆ'Ã†â€™ÃƒÆ'Ã†â€™o do nÃƒÆ'Ã†â€™Ãƒâ€šÃ‚Âºcleo.")
